...
const tagList = [
  { val: 'Plasmid', definition: "Plusmid Definition", isChecked: false },
  { val: 'SNP', definition: "SNP Definition", isChecked: false },
  { val: 'Biologic1', definition: "Biologic1 Definition", isChecked: false },
  { val: 'Biologic2', definition: "Biologic2 Definition", isChecked: false },
  { val: 'Biologic3', definition: "Biologic3 Definition", isChecked: false },
  { val: 'Biologic4', definition: "Biologic4 Definition", isChecked: false }
];
...
const CreateTransaction = () => {
    ...
    const [tokenNumbers, setTokenNumbers] = useState<number>(20000);
    ...
    return (
        <IonContent>
            ...
            <IonItem>
                ...
                <IonInput type="number" placeholder="Suggested number of shares: 20000" required={true} onIonChange={(e) => setTokenNumbers(parseInt(e.detail.value!))}></IonInput>
            </IonItem>
            <IonItem>
            ...
            <IonItem>
                <IonLabel><Link to={`/categorydefinition`}>Category</Link></IonLabel>
