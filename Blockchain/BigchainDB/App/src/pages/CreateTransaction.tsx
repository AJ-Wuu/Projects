...
const CreateTransaction: React.FC = () => {
    ...
    const [createAssetSuccessfully, setCreateAssetSuccessfully] = useState(false);
    ...
    const handleCreate = async () => {
        ...
        Create(
            ...
            setCreateAssetSuccessfully(true);
        });
    }
    ...
    return (
        <IonContent>
            ...
            <IonAlert 
                isOpen={createAssetSuccessfully} 
                onDidDismiss={() => setCreateAssetSuccessfully(false)} 
                header={"Asset Created Successfully!"} 
                message={"You can now create another asset or go back to home page."} 
                buttons={[
                    {
                        text: 'Home',
                        handler: () => {setCreateAssetSuccessfully(false); handleGoBackHome(true);}
                    },
                    {
                        text: 'Create Another',
                        handler: () => {setCreateAssetSuccessfully(false); handleGoBackHome(false);}
                    }]} />
