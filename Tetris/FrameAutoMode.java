...
public class FrameAutoMode extends JFrame {
	...
	static FrameAutoMode frame;
	static BoardAutoMode board;

	@SuppressWarnings("unused")
	public FrameAutoMode(Scanner scan) {
		instructions(scan);
		...
		frame = this;
		board = new BoardAutoMode(this);
		ButtonsAutoMode buttons = new ButtonsAutoMode(this, status, board, Width, Height); //there is frame.add() within Buttons() and KeyMoves()
