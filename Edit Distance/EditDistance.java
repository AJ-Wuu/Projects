...
public class EditDistance {
	...
	//If insert & delete cost 1, replace costs 0, minimum edit distance is equivalent to finding longest common subsequence.
	//Note: a subsequence is sequential, but not necessarily contiguous.
