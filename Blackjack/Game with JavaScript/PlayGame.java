...
public class PlayGame {	
	...
	public void initializeGame() {
		...
		//Get the amount of players & Create them
		do {
		...
		//Ask for player names & Assign them
	...
	//Take the user commands to hit or stand
	...
	//Calculate all possible outcomes & Add or Removes the player bets
	...
	//Print the players banks & Tell the player if s/he is out of the game
	...
	//Decide to force the game to end when all players lose or Let players choose to keep playing or not
	...
	//End game when all players are out of the game or players decide to stop playing
	public void endGame() {
		int endAmount;
